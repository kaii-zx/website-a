...
document.addEventListener("DOMContentLoaded", function () {
  const { gsap, SplitText, ScrambleTextPlugin, CustomEase } = window;

  if (!gsap || !SplitText || !ScrambleTextPlugin || !CustomEase) {
    console.error("GSAP plugins failed to load. Please ensure the GSAP library and plugins are included before main.js.");
    return;
  }
